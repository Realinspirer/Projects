...
show_more_manager.manage_show_more("/JSON_data/Projects_game_assets/Game_assets.json",
     "assets_load_more_btn" ,
     "assets_show_less_btn",
      "assets_section_parent",
       game_assets_generator, null, 3);
